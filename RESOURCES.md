...
*   **Rails 基礎 & Tips**
    ...
    *   🔗 [Rails Validations vs DB Constraints](https://guides.rubyonrails.org/active_record_validations.html#why-use-validations-questionmark)
    *   📝 **[Why]** [モデルバリデーション vs DB 制約の棲み分けとマッピング](./%5BRuby%5D_%5BFw%5D_Rails/rails-validation-vs-db-constraint-comparison.md)
    *   🔗 [Active Record Associations](https://guides.rubyonrails.org/association_basics.html)
    *   📝 **[Concept]** [自己参照による階層構造（ホールディングス等）の管理](./%5BRuby%5D_%5BFw%5D_Rails/active-record-self-referential-association.md)
    *   📝 **[Concept]** [多対多と `has_many :through` (非推奨な過去の手法も含む)](./%5BRuby%5D_%5BFw%5D_Rails/active-record-has-many-through-association.md)
